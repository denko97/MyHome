...
lock_topic = ['MyHomeManager/Lock/sts', 'MyHomeManager/Lock/cmd']
temp_topic = 'MyHomeManager/Temperature/sts'
dust_topic = 'MyHomeManager/Dust/sts'
app_topic = 'MyHomeManager/App/Notifications'
