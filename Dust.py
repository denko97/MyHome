...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.ePublisherTopic.setText(dust_topic)
        ...
        formLayot.addRow("Dust Level",self.Dust)
...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        print('Next update')
        dust= 30 + random.randrange(1,200)/10
        current_data='Dust: '+str(dust)
        self.connectionDock.Dust.setText(str(dust))
        self.mc.publish_to(dust_topic,current_data)
